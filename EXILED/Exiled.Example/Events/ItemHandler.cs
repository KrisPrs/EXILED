...
namespace Exiled.Example.Events
{
    ...
    internal sealed class ItemHandler
    {
        ...
        public void OnChangingAmmo(ChangingAmmoEventArgs ev) => Log.Info($"Durability of {ev.Firearm.Type} ({ev.OldAmmo}) is changing. New durability: {ev.NewAmmo}");
        ...
        public void OnReceivingPreference(ReceivingPreferenceEventArgs ev) => Log.Info($"Receiving a preference from {ev.Player.Nickname} - Item: {ev.Item}");
    }
}