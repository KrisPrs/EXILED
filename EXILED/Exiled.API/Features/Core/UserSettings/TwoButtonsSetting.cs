...
namespace Exiled.API.Features.Core.UserSettings
{
    ...
    public class TwoButtonsSetting : SettingBase, IWrapper<SSTwoButtonsSetting>
    {
        ...
        public class TwoButtonsConfig : SettingConfig<TwoButtonsSetting>
        {
            ...
            public override TwoButtonsSetting Create() => new(ProvideIdFromArchives(this.Label), this.Label, this.FirstOption, this.SecondOption, this.DefaultIsSecond, this.HintDescription, 255, this.IsServerOnly, this.HeaderName == null ? null : new HeaderSetting(this.HeaderName, this.HeaderDescription, this.HeaderPaddling));
        }
    }
}